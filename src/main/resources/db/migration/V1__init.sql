...
CREATE TABLE `content_prerolls` (
  ...
  UNIQUE KEY `UKi7cur190kj40gyv57adfiymq1` (`content_id`,`preroll_id`),
...
CREATE TABLE `content_videos` (
  ...
  UNIQUE KEY `UKlrf5eqc1qtvybipjpgh4giec` (`content_id`,`video_id`),
...
CREATE TABLE `preroll_videos` (
  `content_id` varchar(255) NOT NULL,
  `video_id` varchar(255) NOT NULL,
  UNIQUE KEY `UK7aak3fjkgx8dg8stj81xk1hwu` (`content_id`,`video_id`),
...
CREATE TABLE `videos_countries` (
  ...
  UNIQUE KEY `UKew5ksjsucagu8xa46bfr94vev` (`video_id`,`country_id`),
